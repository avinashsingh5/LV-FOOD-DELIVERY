...
function MainCoursefood(){
    const dispatch=useDispatch()
    let Food2=Food.filter((ele)=>ele.titlename==='MainCourse')
    let history=useHistory();
    function prevImage(){
        let box=document.querySelector('.main-card-image')
    ...
    return(
        ...
        <div className="card-image main-card-image" >
            {
                Food2.map((ele)=>{
