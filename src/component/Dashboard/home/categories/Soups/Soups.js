...
function SoupsFood(){
    ...
    let Food3=Food.filter((ele)=>ele.titlename==='Soups');
    ...
    function prevImage(){
        let box=document.querySelector('.soups-card-image')
    ...
    return(
        <div  className="indi-css"> 
            ...
            <div className="card-image soups-card-image" >
                {  
                    Food3.map((ele)=>{
                        return <>
