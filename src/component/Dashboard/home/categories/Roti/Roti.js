...
function RotiFood(){
    ...
    let Food2=Food.filter((ele)=>ele.titlename==='Roti')
    let history=useHistory();
    function prevImage(){
        let box=document.querySelector('.roti-card-image')
    ...
    return(
        ...
        <div className="card-image roti-card-image" >
            {
                Food2.map((ele)=>{
