...
function Kababfood(){
    ...
    let Food1=Food.filter((ele)=>ele.titlename==='KababFood');
    ...
    function prevImage(){
        let box=document.querySelector('.kabab-card-image')
    ...
    return(
        ...
        <div className="card-image kabab-card-image" >
            {  
                Food1.map((ele)=>{
                    return <>
